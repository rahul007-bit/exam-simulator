...
# navigations and static build output. Since the FE-040 cutover the built SPA is
# the only UI: if no build is present app routes return 503 rather than 404ing.
