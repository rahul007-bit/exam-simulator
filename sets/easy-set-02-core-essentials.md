# Easy Set 02 — Core Essentials

- **Session ID:** `session-1788619754`
- **Total Tasks:** 17
- **Total Points:** 34 pts
...
### Task 1: Fix Pod CreateContainerConfigError on Missing ConfigMap Key [EASY] (2 pts) (PASSED)
- **ID:** `TR-002`
- **Context:** `k3d-cka`
...
### Task 2: Fix Empty Endpoints on Cart Service [EASY] (2 pts) (PASSED)
- **ID:** `TR-003`
- **Context:** `k3d-cka`
- **Namespace:** `ecommerce`
...
### Task 3: Fix Deployment ImagePullBackOff due to Invalid Tag [EASY] (2 pts) (PASSED)
- **ID:** `TR-004`
- **Context:** `k3d-cka`
- **Namespace:** `warehouse`
...
### Task 4: Clear Stuck Finalizer on Deleting Resource [EASY] (2 pts) (PASSED)
- **ID:** `TR-010`
- **Context:** `k3d-cka`
...
### Task 5: Fix Base64 Encoding Error in Pod Secret Reference [MEDIUM] (2 pts) (PASSED)
- **ID:** `TR-021`
- **Context:** `k3d-cka`
- **Namespace:** `payments`
...
### Task 6: Configure InitContainer Dependency Gate on Frontend Pod [EASY] (2 pts) (PASSED)
- **ID:** `WL-002`
- **Context:** `k3d-cka`
...
### Task 7: Create CronJob with History Limits [EASY] (2 pts) (PASSED)
- **ID:** `WL-007`
- **Context:** `k3d-cka`
...
### Task 8: Create Batch Job with Parallelism and Completions [EASY] (2 pts) (PASSED)
- **ID:** `WL-009`
- **Context:** `k3d-cka`
...
### Task 9: Configure Ingress Path Routing for Auth and Pay Services [EASY] (2 pts) (PASSED)
- **ID:** `CA-007`
- **Context:** `k3d-cka`
...
### Task 10: Expose Application via NodePort Service on Specific Port [EASY] (2 pts) (PASSED)
- **ID:** `CA-009`
- **Context:** `k3d-cka`
...
### Task 11: Deploy Microservice ClusterIP Backends [EASY] (2 pts) (PASSED)
- **ID:** `CA-015`
- **Context:** `k3d-cka`
...
### Task 12: Configure RBAC ServiceAccount & Role for Deployment Management [EASY] (2 pts) (PASSED)
- **ID:** `SC-001`
- **Context:** `k3d-cka`
...
### Task 14: Configure ServiceAccount and Scoped Configuration Role [EASY] (2 pts) (PASSED)
- **ID:** `SC-010`
- **Context:** `k3d-cka`
...
### Task 15: Create PersistentVolume and Bind to PersistentVolumeClaim [EASY] (2 pts) (PASSED)
- **ID:** `ST-001`
- **Context:** `k3d-cka`
...
### Task 16: Create Local PersistentVolume with NodeAffinity [EASY] (2 pts) (PASSED)
- **ID:** `ST-005`
- **Context:** `k3d-cka`
- **Namespace:** `default`
...
### Task 17: Configure Projected Volume Aggregating Secret and DownwardAPI [EASY] (2 pts) (CURRENT ACTIVE TASK)
- **ID:** `ST-009`
- **Context:** `k3d-cka`
