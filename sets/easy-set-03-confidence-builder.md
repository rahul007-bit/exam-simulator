# Easy Set 03 — Confidence Builder

- **Session ID:** `session-1788620422`
- **Total Tasks:** 17
- **Total Points:** 34 pts
...
### Task 1: Create PersistentVolume and Bind to PersistentVolumeClaim [EASY] (2 pts) (PASSED)
- **ID:** `ST-001`
- **Context:** `k3d-cka`
...
### Task 2: Create Local PersistentVolume with NodeAffinity [EASY] (2 pts) (PASSED)
- **ID:** `ST-005`
- **Context:** `k3d-cka`
- **Namespace:** `default`
...
### Task 3: Configure Projected Volume Aggregating Secret and DownwardAPI [EASY] (2 pts) (PASSED)
- **ID:** `ST-009`
- **Context:** `k3d-cka`
...
### Task 8: Create CronJob with History Limits [EASY] (2 pts) (PASSED)
- **ID:** `WL-007`
- **Context:** `k3d-cka`
...
### Task 9: Create Batch Job with Parallelism and Completions [EASY] (2 pts) (PASSED)
- **ID:** `WL-009`
- **Context:** `k3d-cka`
...
### Task 15: Configure Ingress Path Routing for Auth and Pay Services [EASY] (2 pts) (PASSED)
- **ID:** `CA-007`
- **Context:** `k3d-cka`
...
### Task 17: Deploy Microservice ClusterIP Backends [EASY] (2 pts) (CURRENT ACTIVE TASK)
- **ID:** `CA-015`
- **Context:** `k3d-cka`
